<div x-data="diagnosisForm()" x-ref="alpineRoot">
    ...
    <div class="row">
        {{-- ============================== --}}
        {{-- Col Kiri: History Diagnosis    --}}
        {{-- ============================== --}}
        <div class="col-md-5">
            <div class="panel panel-inverse mb-4">
                <div class="panel-heading">
                    <h4 class="panel-title">
                        <i class="fa fa-history me-2"></i>History Diagnosis
                    </h4>
                </div>
                <div class="panel-body p-3" style="flex: 1; background-color: #f8fafc; min-height: 0;">
                    @php
                    ...
                    <div class="history-pa-timeline">
                        @foreach ($data->pasien->rekamMedis->where('id', '!=', $data->id) as $row)
                            @if ($row->diagnosis)
                                ...
                                <div class="history-pa-item">
                                    <div class="history-pa-card p-3 shadow-sm border border-1 border-gray-200">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-6 border-end-md pb-3 pb-md-0">
                                                <div class="section-title-pa">
                                                    <i class="fa fa-stethoscope me-2 text-danger"></i>Diagnosis (ICD-10)
                                                </div>
                                                <ul class="list-unstyled ps-0 mb-0">
                                                    @forelse ($row->diagnosis->icd10_uraian as $item)
                                                        <li class="fs-12px text-dark mb-2 d-flex align-items-start">
                                                            <span class="badge bg-danger-transparent text-danger border border-danger me-2 px-2 py-1 rounded font-monospace fs-11px"
                                                                style="background: rgba(255, 91, 87, 0.1); border-color: rgba(255, 91, 87, 0.2) !important;">
                                                                {{ $item->id }}
                                                            </span>
                                            ...
                                            <div class="col-lg-4 col-md-6 border-end-md pb-3 pb-md-0">
                                                <div class="section-title-pa">
                                                    <i class="fa fa-balance-scale me-2 text-warning"></i>Diagnosis Banding
                                                </div>
                                            ...
                                            <div class="col-lg-4 col-md-12 pt-3 pt-lg-0">
                                                <div class="section-title-pa">
                                                    <i class="fa fa-file-alt me-2 text-success"></i>Dokumentasi
                                                </div>
                                                <div class="row g-2">
                                                        ...
                                                        <div class="col-6 col-sm-4 col-lg-6">
                                                            <div class="card h-100 border-1 border-gray-200">
                                                                <a href="{{ Storage::url($item->link) }}" target="_blank"
                                                                    class="d-block text-center bg-gray-100 p-1">
                                                                    <img src="{{ Storage::url($item->link) }}"
                                                                        class="img-fluid rounded"
                                                                        style="max-height: 80px; object-fit: contain;">
                                                                </a>
                                                                <div class="p-2 border-top">
                                                                    <div class="fw-bold fs-10px text-truncate"
                                                                        title="{{ $item->judul }}">
                                                                        {{ $item->judul }}
                                                                    </div>
                                                                    <div class="text-muted fs-9px text-truncate"
                                    ...
                                    </div>{{-- end .history-pa-card --}}
                                </div>{{-- end .history-pa-item --}}
                            @endif
                        @endforeach
                        ...
                        @endif
                    </div>{{-- end .history-pa-timeline --}}
                </div>{{-- end .panel-body --}}
            </div>{{-- end .panel --}}
        </div>{{-- end .col-md-5 --}}

        {{-- ============================== --}}
        {{-- Col Kanan: Form Assessment    --}}
        {{-- ============================== --}}
        <div class="col-md-7">
            <form wire:submit.prevent="submit"
                @submit.prevent="syncToLivewire()"
                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea id="diagnosis_banding" class="form-control"
                                wire:model="diagnosis_banding"
                                placeholder="Tuliskan kemungkinan diagnosis lain yang perlu dipertimbangkan...">
                            </textarea>
                    ...
                    <div class="panel-footer">
                        ...
                        @if (isset($data->diagnosis) && $data->diagnosis->count() > 0)
                            <button type="button" class="btn btn-info m-r-3"
                                wire:loading.attr="disabled"
                ...
                return {
                    ...
                    refreshSelect2() {
                        ...
                        $(root).find('select.form-control').each(function(i, el) {
                            ...
                            el.dispatchEvent(new CustomEvent('updateSelect2Value', { bubbles: true }));
                        });
                    },

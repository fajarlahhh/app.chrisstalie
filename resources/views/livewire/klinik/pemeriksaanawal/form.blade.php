    ...
    <div class="tab-content panel rounded-0 p-3 m-0">
        ...
        <div class="tab-pane fade" id="default-tab-1" role="tabpanel" wire:ignore.self>
            <div class="panel panel-inverse mb-4" style="height: 400px; display: flex; flex-direction: column;">
                <div class="panel-heading">
                    <h4 class="panel-title"><i class="fa fa-history me-2"></i>History Tes Up and Go</h4>
                </div>
                <div class="panel-body overflow-auto p-3" style="flex: 1; background-color: #f8fafc; min-height: 0;">
                    @php
                        $historyTugCount = 0;
                                    ...
                                    <div class="history-pa-card p-3 shadow-sm border border-1 border-gray-200">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 border-end-md pb-3 pb-md-0">
                                                <div class="section-title-pa"><i class="fa fa-running me-2 text-info"></i>Hasil Tes</div>
                                                <div class="fs-12px mb-2">
                                                    <strong>Waktu Tes:</strong>
                                                    <span class="badge bg-info text-white ms-1 fs-11px">{{ $row->tug->waktu_tes_detik }} detik</span>
                                                </div>
                                                <div class="fs-12px">
                                                    <strong>Observasi Kualitatif Gerakan:</strong>
                                                    <ul class="list-unstyled ps-0 mt-1 mb-0">
                                                        @php
                                                            $observasi = is_string($row->tug->observasi_kualitatif) ? json_decode($row->tug->observasi_kualitatif, true) ?? [] : (is_array($row->tug->observasi_kualitatif) ? $row->tug->observasi_kualitatif : []);
                                                        @endphp
                                            ...
                                            <div class="col-md-6 pt-3 pt-md-0">
                                                <div class="section-title-pa"><i class="fa fa-clipboard-list me-2 text-warning"></i>Catatan & Rekomendasi</div>
                                                <div class="fs-12px">

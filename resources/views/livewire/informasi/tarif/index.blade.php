                                ...
                                <div class="note-content">
                                    ...
                                    <table class="w-100">
                                        ...
                                        <tr>
                                            <td>Tarif</td>
                                            <td class="w-10px">:</td>
                                            <td>Rp. {{ number_format_id($data->tarif) }}</td>
                                        </tr>
                                        <tr>
                                            <td>Catatan</td>
                                            <td class="w-10px">:</td>
                                            <td nowrap>{!! nl2br(e($data->catatan)) !!}</td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6" x-data="{
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td class="pt-2 pb-2 text-end"><strong x-text="formatRupiah(tarifAkhir)"></strong>
                                    </td>
                                </tr>
                            </table>
                        </div>
                                ...
                                <div class="note-content">
                                    ...
                                    <table class="w-100">
                                        @foreach ($data->paketPerawatanDetail as $item)
                                            <tr>
                                                <td>{{ $item->tarifTindakan->nama }}</td>
                                                <td>{{ $item->qty }} x</td>
                                                <td>Rp. {{ number_format_id($item->tarifTindakan->tarif) }}</td>
                                            </tr>
                                        @endforeach
                                    </table>
                                </div>

                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <div class="text-start">
                                                ...
                                                <small
                                                    ...
                                                    class="d-block fs-10px text-truncate"
                                                    ...
                                                    <div class="bg-success-100 p-3 rounded">
                                                        ...
                                                        <div class="row g-3 p-3">
                                                            <div class="col-sm-6">
                                                                <small class="text-muted d-block fs-10px">Keluhan
                                                                    Utama</small>
                                                                <span
                                                                    class="text-dark fs-12px fw-semibold">{{ $row->pemeriksaanAwal?->keluhan_utama ?: '-' }}</span>
                                                            </div>
                                                            <div class="col-sm-6">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <small class="text-muted d-block fs-10px">Riwayat
                                                                    Alergi</small>
                                                                <span
                                                                    class="text-dark fs-12px text-danger fw-semibold">{{ $row->pemeriksaanAwal?->riwayat_alergi ?: '-' }}</span>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <span class="text-dark fw-bold d-block mb-2">
                                                                ...
                                                                <div class="ttv-card">
                                                                    <div>
                                                                        <small
                                                                            ...
                                                                            Darah</small>
                                                                        <strong
                                                                            class="text-dark fs-12px">{{ $row->pemeriksaanAwal?->tekanan_darah ?: '-' }}
                                                                            <span
                                                            ...
                                                            <div class="col-6 col-md-4">
                                                                <div class="ttv-card">
                                                                    <div>
                                                                        ...
                                                                        <strong
                                                                            class="text-dark fs-12px">{{ $row->pemeriksaanAwal?->nadi ?: '-' }}
                                                                            <span
                                                            ...
                                                            <div class="col-6 col-md-4">
                                                                <div class="ttv-card">
                                                                    <div>
                                                                        ...
                                                                        <strong
                                                                            class="text-dark fs-12px">{{ $row->pemeriksaanAwal?->suhu ?: '-' }}
                                                                            <span
                                                            ...
                                                            <div class="col-6 col-md-4">
                                                                <div class="ttv-card">
                                                                    <div>
                                                                        ...
                                                                        <strong
                                                                            class="text-dark fs-12px">{{ $row->pemeriksaanAwal?->saturasi_o2 ?: '-' }}
                                                                            <span
                                                                ...
                                                                <div class="ttv-card">
                                                                    <div>
                                                                        <small
                                                                            ...
                                                                            / Tinggi</small>
                                                                        <strong
                                                                            class="text-dark fs-12px">{{ $row->pemeriksaanAwal?->berat_badan ?: '-' }}
                                                                            <span
                                                            ...
                                                            <div class="col-6 col-md-4">
                                                                <div class="ttv-card">
                                                                    <div>
                                                                        ...
                                                                        <strong
                                                                            class="text-dark fs-12px">{{ $row->pemeriksaanAwal?->pernapasan ?: '-' }}
                                                                            <span
                                                                                class="fs-10px text-muted fw-normal">x/mnt</span></strong>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="ttv-card">
                                                                    <div>
                                                                        ...
                                                                        <strong
                                                                            ...
                                                                            style="max-width: 120px;">{{ $row->pemeriksaanAwal?->kesadaran ?: '-' }}</strong>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-6 col-md-4">
                                                                <div class="ttv-card">
                                                                    <div>
                                                                        ...
                                                                        <strong
                                                                            class="text-dark fs-12px text-truncate d-block"
                                                                            style="max-width: 120px;">{{ $row->pemeriksaanAwal?->kesan_sakit ?: '-' }}</strong>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-6 col-md-4">
                                                                <div class="ttv-card">
                                                                    <div>
                                                                        ...
                                                                        <strong
                                                                            class="text-dark fs-12px text-truncate d-block"
                                                                            style="max-width: 120px;">{{ $row->pemeriksaanAwal?->status_gizi ?: '-' }}</strong>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row g-3 p-3">
                                                            <div class="col-md-4 col-sm-6">
                                                                <small class="text-muted d-block fs-10px">Kepala, Mata,
                                                                    THT, Leher</small>
                                                                <span
                                                                    class="text-dark fs-12px fw-semibold">{{ $row->pemeriksaanAwal?->kepala_normal == 1 ? 'Normal' : ($row->pemeriksaanAwal?->kepala_temuan ?: '-') }}</span>
                                                            </div>
                                                            <div class="col-md-4 col-sm-6">
                                                                <small
                                                                    class="text-muted d-block fs-10px">Jantung</small>
                                                                <span
                                                                    class="text-dark fs-12px fw-semibold">{{ $row->pemeriksaanAwal?->jantung_normal == 1 ? 'Normal' : ($row->pemeriksaanAwal?->jantung_temuan ?: '-') }}</span>
                                                            </div>
                                                            <div class="col-md-4 col-sm-6">
                                                                <small class="text-muted d-block fs-10px">Paru</small>
                                                                <span
                                                                    class="text-dark fs-12px fw-semibold">{{ $row->pemeriksaanAwal?->paru_normal == 1 ? 'Normal' : ($row->pemeriksaanAwal?->paru_temuan ?: '-') }}</span>
                                                            </div>
                                                            <div class="col-md-4 col-sm-6">
                                                                <small
                                                                    class="text-muted d-block fs-10px">Abdomen</small>
                                                                <span
                                                                    class="text-dark fs-12px fw-semibold">{{ $row->pemeriksaanAwal?->abdomen_normal == 1 ? 'Normal' : ($row->pemeriksaanAwal?->abdomen_temuan ?: '-') }}</span>
                                                            </div>
                                                            <div class="col-md-4 col-sm-6">
                                                                <small
                                                                    class="text-muted d-block fs-10px">Ekstremitas</small>
                                                                <span
                                                                    class="text-dark fs-12px fw-semibold">{{ $row->pemeriksaanAwal?->ekstremitas_normal == 1 ? 'Normal' : ($row->pemeriksaanAwal?->ekstremitas_temuan ?: '-') }}</span>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                            ...
                                                            <div class="row g-3">
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <strong class="text-dark fs-13px text-primary">
                                                                        {{ $row->pemeriksaanAwal?->diagnosis_kerja ?: '-' }}</strong>
                                                                </div>
                                                                <div class="col-sm-6">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="alert bg-red-100 mb-0 p-3">
                                                        ...
                                                        <div
                                                            ...
                                                            <span
                                                                class="text-dark">{{ number_format_id($row->pembayaran->total_tagihan) }}</span>
                                                        </div>

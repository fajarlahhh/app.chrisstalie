    ...
    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
        ...
        <div class="panel-heading overflow-auto d-flex">
            ...
            <div class="ms-auto d-flex align-items-center">
                ...
                &nbsp;
                <select id="kategori"  class="form-control w-auto" wire:model.lazy="kategori">
                    <option value="">Semua Kategori</option>
                    <option value="1">Sistem</option>
                    <option value="2">Manual</option>
                </select>
                &nbsp;
                <input id="tanggal1"  type="date" class="form-control w-auto" wire:model.lazy="tanggal1" max="{{ date('Y-m-d') }}">
                &nbsp;
                <input id="tanggal2"  type="date" class="form-control w-auto" wire:model.lazy="tanggal2" max="{{ date('Y-m-d') }}">
                &nbsp;
